...
The Skill uses transparent ROS 2 interfaces directly. Motion 4–08 explain the individual MoveIt/QP arm controllers; this guide focuses on coordinating perception, arm motion, and the dexterous hand. Read [Motion 5 · MoveIt End Pose](../../../atom/motion/docs/motion05_arm_moveit_endpose_guide.md) and [Motion 7 · QP End Pose](../../../atom/motion/docs/motion07_arm_qp_endpose_guide.md) first if those controllers are unfamiliar.
