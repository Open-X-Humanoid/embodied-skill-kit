...
# -*- coding: utf-8 -*-
"""
原子示例 · 原25 · 相机（Camera） —— ROS2 原生版 [生产级]
读取 Orbbec 相机的 RGB + 深度 + 内参，保存三件套并打印关键信息。
配套讲解文档: atom/docs/atom25_camera_guide.md
...
def main() -> None:
    ...
    try:
        ...
        rgb_path       = os.path.join(OUT_DIR, "atom25_rgb.jpg")
        depth_path     = os.path.join(OUT_DIR, "atom25_depth.png")        # png 保留 16 位
        depth_vis_path = os.path.join(OUT_DIR, "atom25_depth_color.jpg")
