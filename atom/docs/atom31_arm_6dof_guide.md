# Atom 31 · 6-DoF F/T Sensor · Wrist Force / Torque Readout

**English** | [简体中文](atom31_arm_6dof_guide_zh-CN.md)
...
| Companion code |
|---|
| `atom/demos/atom31_arm_6dof_ros2.py` (native ROS2) |
...
`atom31_arm_6dof_ros2.py` is **four modules**. It is one of the shortest atoms — F/T is read-only, with no control flow.
