...
def main():
    ...
    log = node.get_logger()
    log.info(f"运控7 · 手臂 QP 末端控制 | 控制器={QP_CONTROLLER} {FROM_FRAME}→{TO_FRAME} 平移={DEMO_DELTA_XYZ}m")
