...
# -*- coding: utf-8 -*-
"""
原子示例 · 感知1 · 相机（Camera） —— ROS2 原生版
读取 Orbbec 相机一帧 RGB 图并保存。   配套讲解文档: atom/perception/docs/perception01_camera_guide.md
...
def main() -> None:
    ...
    try:
        ...
        out = os.path.join(OUT_DIR, "perception01_rgb.jpg")
