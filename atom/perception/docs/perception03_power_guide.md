# Perception 3 · Power · Battery Level & E-Stop Key Readout

**English** | [简体中文](perception03_power_guide_zh-CN.md)
...
| Companion code |
|---|
| `atom/perception/perception03_power_ros2.py` (native ROS2) |
...
`perception03_power_ros2.py` is **four modules**, same structure as perception02 (F/T) — pure read, timer-based print.
